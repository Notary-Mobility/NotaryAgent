...
public class MyCardsPayment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (bundle!=null&&!bundle.isEmpty()){
            amount_str = bundle.getString("amount");
        }
        idinit();
        clickevent();
    }
    ...
    private void clickevent() {
        addcard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(MyCardsPayment.this,AddCreditCardAct.class);
                startActivity(i);
            }
        });
...
//http://technorizen.com/transport/webservice/strips_payment?transaction_type=&payment_type=&amount=&user_id=&request_id=&tip=&time_zone=&car_charge=&token=&currency=
               ...
               // Log.e("postReceiverUrl >>"," >>"+postReceiverUrl+"transaction_type=add_to_wallet&amount="+amount_str+"&payment_type=Card&user_id="+user_id+"&time_zone="+time_zone+"&token="+card_id+"&currency=usd");
                ...
                params.put("customer", WalletActivity.cust_id);
