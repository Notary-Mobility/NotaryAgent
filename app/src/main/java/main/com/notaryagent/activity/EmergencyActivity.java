                ...
                if (name_str == null || name_str.equalsIgnoreCase("")) {
                    ...
                    if (emergency_id == null || emergency_id.equalsIgnoreCase("")) {
                        if (mobile_str == null || mobile_str.equalsIgnoreCase("")) {
                            ...
                            Toast.makeText(EmergencyActivity.this, getResources().getString(R.string.plsentervalidnumber), Toast.LENGTH_LONG).show();
                        }
                        else {
                            new AddEmergencyContact().execute("add");
                        }
...
//http://halatx.halasmart.com/hala/webservice/emergency_number?email=v@g.com&mobile=895856585&name=vvv
            //http://halatx.halasmart.com/hala/webservice/update_number?id=2&email=v@g.com&mobile=895856585&name=vvv
            try {
